        ...
        <div className={`min-h-screen p-6 pb-32 transition-colors duration-300 ${theme === 'dark' ? 'bg-black text-white' : 'bg-zinc-50 text-zinc-900'}`}>
            ...
            <div className="flex p-1 bg-zinc-200 dark:bg-zinc-900 rounded-xl mb-6">
                <button
                    ...
                    className={`flex-1 py-3 rounded-lg text-base font-bold uppercase tracking-wider flex items-center justify-center gap-2 transition-all ${activeTab === 'drinks'
                ...
                <button
                    ...
                    className={`flex-1 py-3 rounded-lg text-base font-bold uppercase tracking-wider flex items-center justify-center gap-2 transition-all ${activeTab === 'food'
                            ? (theme === 'dark' ? 'bg-zinc-800 text-white shadow-lg' : 'bg-white text-black shadow-md')
                            : (theme === 'dark' ? 'text-zinc-400 hover:text-zinc-200' : 'text-zinc-500 hover:text-zinc-700')
                        }`}
                >
            ...
            `}
                    >
                        ...
                        <div className="absolute bottom-0 left-0 p-4 z-20 w-full">
                            {(index === 0 && activeTab === 'drinks') && <span className="text-shaco-red text-base font-bold uppercase tracking-wider mb-1 block">İmza Karışım</span>}
                            <div className="flex justify-between items-end">
                                <div>
                                    ...
                                    <p className="text-zinc-400 text-base mt-1 line-clamp-1">{product.shortDesc}</p>
                                </div>
                                <div className="bg-white/10 backdrop-blur-md px-2 py-1 rounded text-base font-bold text-white">
                                    ₺{product.price}
                                </div>
                            </div>
                        </div>
