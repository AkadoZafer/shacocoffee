        ...
        <div className="min-h-screen bg-black flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="w-full max-w-sm">
                ...
                <div className="glass-dark p-6 rounded-3xl border border-white/10">
                    ...
                    <p className="text-zinc-600 text-[15px] text-center mb-5">Shaco ailesine katılın</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                        ...
                        <div className="flex gap-2">
                            <div className="relative flex-1">
                                ...
                                <input
                                    ...
                                    placeholder="Ad"
                                    className="w-full bg-black/50 border border-zinc-800 text-white pl-9 pr-3 py-3 rounded-xl focus:outline-none focus:border-shaco-red transition text-base font-display placeholder:text-zinc-700"
                                />
                            </div>
                            <div className="relative flex-1">
                                <input
                                    ...
                                    placeholder="Soyad"
                                    className="w-full bg-black/50 border border-zinc-800 text-white px-3 py-3 rounded-xl focus:outline-none focus:border-shaco-red transition text-base font-display placeholder:text-zinc-700"
                                />
                            </div>
                        </div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                placeholder="Şifre"
                                className="w-full bg-black/50 border border-zinc-800 text-white pl-9 pr-9 py-3 rounded-xl focus:outline-none focus:border-shaco-red transition text-base font-display placeholder:text-zinc-700"
                            />
                        ...
                        <button
                            ...
                            className="w-full text-zinc-500 text-base font-bold hover:text-shaco-red transition py-1"
                        >
