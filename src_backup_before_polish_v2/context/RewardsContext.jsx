...
export function RewardsProvider({ children }) {
    ...
    const [orders, setOrders] = useState(() => {
        const saved = localStorage.getItem('shaco_orders');
    ...
    useEffect(() => {
        localStorage.setItem('shaco_orders', JSON.stringify(orders));
    }, [orders]);
    ...
    const checkoutCart = () => {
        ...
        if (deductBalance(total)) {
            ...
            // Auto-dismiss active order banner after 30 seconds (order stays in history)
