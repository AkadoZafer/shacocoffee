                                ...
                                <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="px-4 pb-4">
                                    <div className="space-y-4 pt-2">
                                        <div className="space-y-1">
                                            <label className={`text-[10px] uppercase font-bold tracking-wider ${isDark ? 'text-zinc-500' : 'text-zinc-400'}`}>Ad Soyad</label>
                                            <input
                                                type="text"
                                                value={formData.name}
                                                onChange={(e) => setFormData({ ...formData, name: e.target.value })}
                                                className={`w-full p-3 rounded-xl text-sm ${isDark ? 'bg-zinc-800/50 text-white' : 'bg-zinc-50 text-zinc-900'}`}
                                            />
                                        </div>
                                        <div className="space-y-1">
                                            <label className={`text-[10px] uppercase font-bold tracking-wider ${isDark ? 'text-zinc-500' : 'text-zinc-400'}`}>Telefon</label>
                                            <input
                                                type="tel"
                                        ...
                                        <div className="space-y-1">
                                            <label className={`text-[10px] uppercase font-bold tracking-wider ${isDark ? 'text-zinc-500' : 'text-zinc-400'}`}>Doğum Tarihi</label>
                                            <input
                                                type="date"
                                        ...
                                        <button
                                            ...
                                            className="w-full py-3 bg-shaco-red text-white text-sm font-bold rounded-xl flex items-center justify-center gap-2 active:scale-95 transition"
                                        >
                                            <Save size={16} /> Kaydet
                                        </button>
                                    </div>
